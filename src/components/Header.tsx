                ...
                <div className="mx-auto flex max-w-5xl items-center gap-3 px-6 py-3.5">
                    ...
                    <div className="ml-auto flex items-center gap-3">
                        {isLoading ? (
                            ...
                            <>
                                {user.plan === "pro" ? (
                                    <span className="flex h-7 items-center rounded-lg bg-accent/20 px-2.5 text-[10px] font-bold uppercase tracking-wider text-accent-bright ring-1 ring-accent/30">
                                        Pro
                                    </span>
                                ) : (
                                    <button
                                        onClick={() => setIsPricingOpen(true)}
                                        className="flex h-7 items-center rounded-lg bg-gradient-to-r from-accent to-purple-600 px-3 text-[11px] font-bold text-white shadow-lg transition-all hover:scale-105 hover:shadow-accent/20"
                                    >
                                        Upgrade
                                    </button>
                                )}
